...
var ScrollU = function (_a) {
    var className = _a.className, renderItem = _a.renderItem, _b = _a.initialItems, initialItems = _b === void 0 ? [] : _b, _c = _a.showScrollBar, showScrollBar = _c === void 0 ? true : _c, _d = _a.scrollBarRender, scrollBarRender = _d === void 0 ? function (height, top) { return (jsxRuntime.jsx(DefaultScrollBar, { height: height, top: top })); } : _d, props = __rest(_a, ["className", "renderItem", "initialItems", "showScrollBar", "scrollBarRender"]);
    var containerRef = React.useRef(null);
    var contentRef = React.useRef(null);
    var _e = React.useState(0), translateY = _e[0], setTranslateY = _e[1];
    var _f = React.useState({ height: 0, top: 0 }), scrollBar = _f[0], setScroll = _f[1];
    ...
    return (jsxRuntime.jsxs("div", __assign({ ref: containerRef, className: cn('relative', 'h-full', 'overflow-hidden', className) }, props, { children: [jsxRuntime.jsx("div", { ref: contentRef, style: {
